...
function renderComponentsPage() {
  ...
  const solidColors = [
    ...
    { color: 'fandango', icon: 'favorite', title: 'Fandango Card', value: '567', subtitle: 'Bold pink-purple' },
  ...
  accentSection.innerHTML = `
    ...
    <p class="text-sm text-rewst-gray mb-4">Use <code>cardClass: 'card-accent-teal'</code> for a white card with colored left border</p>
  `;
  ...
  const accentColors = [
    { color: 'teal', icon: 'analytics', title: 'Accent Teal', value: '99.9%', subtitle: 'White card, teal left border', cardClass: 'card-accent-teal' },
    { color: 'fandango', icon: 'star', title: 'Accent Fandango', value: '256', subtitle: 'White card, fandango left border', cardClass: 'card-accent-fandango' },
    { color: 'orange', icon: 'bolt', title: 'Accent Orange', value: '38m', subtitle: 'White card, orange left border', cardClass: 'card-accent-orange' },
  ];
